...
// HTML más compacto (misma info, menos estilos y anidamiento)
...
export const generarTicket = async (pedido, detalles, factura, titularId) => {
  ...
  // Asegurar formato de vtoCAE (YYYYMMDD sin guiones)
  ...
  // Lanzar puppeteer con opciones para Windows y timeout
